				...
				<div
					...
					<div class="pr-3">
						...
						<div class="flex flex-col gap-2">
							<a	href="https://github.com/Sridharfiles" 
								target="_blank"
								...
								<img src="/img/icons/side-menu/github-icon.webp" alt="GitHub" class="w-4 h-4 flex-shrink-0" />
								<span>GitHub</span>
							</a>
							<a  href="https://www.linkedin.com/in/sridhark-/"
								target="_blank"
								class="bg-button-submit hover:shadow-button-submit-hover active:bg-button-clicked border border-twilight-blue rounded px-3 py-1 text-xs text-black flex items-center justify-center gap-2 cursor-pointer shadow-sm">
								<img src="/img/icons/side-menu/linkedin-icon.webp" alt="LinkedIn" class="w-4 h-4 flex-shrink-0" />
								<span>LinkedIn</span>
							</a>
						</div>
